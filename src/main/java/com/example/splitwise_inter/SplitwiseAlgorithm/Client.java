package com.example.splitwise_inter.SplitwiseAlgorithm;


import com.example.splitwise_inter.SplitwiseAlgorithm.algorithms.GreedyAlgorithm;
import com.example.splitwise_inter.SplitwiseAlgorithm.algorithms.SettlementStrategy;
import com.example.splitwise_inter.SplitwiseAlgorithm.models.ExpensePaidBy;
import com.example.splitwise_inter.SplitwiseAlgorithm.models.ExpenseSharedBy;
...
public class Client {
    public static void main(String[] args) {
        ...
        List<Transaction> transactions = settleExpenses(paidByList, sharedByList, (SettlementStrategy) new GreedyAlgorithm());
    ...
    static List<Transaction> settleExpenses(List<ExpensePaidBy> paidByList,
        ...
        for(ExpenseSharedBy sharedBy: sharedByList){
            ...
            if(balanceSheet.containsKey(name)){
                ...
                balanceSheet.put(name, -amount);// negative amount
            }
        }
